...
## Veryfi Lens Headless Receipts Android Example <a name="example"></a>
This is an example of how to use Veryfi Lens Headless Receipts in your app, you can find the developer documentation [here](https://app.veryfi.com/lens/docs/android/).

![LensReceiptsDemo](headless-receipts-demo.gif)

## How to add Veryfi Lens Headless Receipts to your project <a name="maven"></a>
...
```ruby
dependencies {
    implementation 'com.veryfi.lens.headless:receipts-sdk:2.1.0.25'
}
```
